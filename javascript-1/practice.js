...
//Code Here
const middleNums = numbers.filter( (el, i, arr) => (i !== 0 && i !== arr.length-1))
//////////////////PROBLEM 11////////////////////
...
const bigOrSmall = (arr) => {
	let answers = []
	arr.map((val) => answers.push( (val > 100) ? "big": "small") )
	return answers
}

bigOrSmallArr = [99, 100, 203, 53, 78, 333]
bigOrSmall(bigOrSmallArr)
...
// Code Here
let filtered = myNumbers.filter((num) =>{
	return num > 100
})
//////////////////PROBLEM 16////////////////////
...
// Code Here
total = myNumbers.reduce((acc, cur) => acc + cur)
//////////////////PROBLEM 17////////////////////
...
// Code Here
let myNumbersIndex = []
myNumbers.forEach( (ele, i) => myNumbersIndex.push(i))
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map( (val) => "George")
//////////////////PROBLEM 19////////////////////
